    ...
    <section className="title">
      ...
      <div className="row justify-content-center">
        <div className="col-10" id="about-section">
          <img className="mb-5 justify-content-center" src="https://raw.githubusercontent.com/MNlegion/MNlegion-React-Port/develop/src/assets/images/Profile%20Picture.png" alt="Profile Robert Kreuser" id='portimg' />
          <p>
